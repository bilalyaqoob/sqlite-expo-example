...
export default class App extends React.Component {
  ...
  componentDidMount() {
    db.transaction(tx => {tx.executeSql("create table if not exists items (id integer primary key not null, done int, value text);")});
  }
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.listArea}>
          ...
          <Items
            ...
            onPressItem={id =>
              db.transaction(tx => {tx.executeSql(`delete from items where id = ?;`, [id])},
                null,
                this.update
              )
            }
